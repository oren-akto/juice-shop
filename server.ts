...
restoreOverwrittenFilesWithOriginals().then(() => {
  ...
  app.post('/profile/image/url-1', uploadToMemory.single('file'), profileImageUrlUpload())
  ...
  app.post('/api/FeedbacksOren', captcha.verifyCaptcha())
  ...
  app.post('/api/AddresssTest', security.appendUserId())
  app.post('/api/AddresssTest2', security.appendUserId())
  app.post('/api/AddresssTest3', security.appendUserId())
  app.post('/api/AddresssTest4', security.appendUserId())
  app.post('/api/AddresssTest5', security.appendUserId())
